...
export default function RatingRules() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* 已分析公司汇总 */}
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-900 mb-4">三、已分析公司评分汇总</h2>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-center">护城河</th>
                <th className="px-3 py-2 text-center">成长性</th>
                <th className="px-3 py-2 text-center">盈利质量</th>
            ...
            <tbody>
              <tr className="border-t">
                <td className="px-3 py-2 font-medium">中国平安</td>
              ...
              <tr className="border-t">
                ...
                <td className="px-3 py-2 text-center">22</td>
                <td className="px-3 py-2 text-center">10</td>
                <td className="px-3 py-2 text-center">16</td>
                <td className="px-3 py-2 text-center text-green-600 font-bold">25</td>
                <td className="px-3 py-2 text-center">5</td>
                <td className="px-3 py-2 text-center font-bold">78</td>
                <td className="px-3 py-2 text-center"><span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-bold">S</span></td>
              </tr>
              <tr className="border-t bg-gray-50">
                <td className="px-3 py-2 font-medium">中际旭创</td>
                <td className="px-3 py-2 text-center">15</td>
                <td className="px-3 py-2 text-center">18</td>
                <td className="px-3 py-2 text-center">18</td>
                <td className="px-3 py-2 text-center">12</td>
                <td className="px-3 py-2 text-center">8</td>
                <td className="px-3 py-2 text-center font-bold">71</td>
                <td className="px-3 py-2 text-center"><span className="bg-green-500 text-white px-2 py-1 rounded text-xs font-bold">S</span></td>
              </tr>
              <tr className="border-t">
                <td className="px-3 py-2 font-medium">中国神华</td>
                <td className="px-3 py-2 text-center">18</td>
                <td className="px-3 py-2 text-center">8</td>
                <td className="px-3 py-2 text-center">16</td>
                <td className="px-3 py-2 text-center">22</td>
                <td className="px-3 py-2 text-center">5</td>
                <td className="px-3 py-2 text-center font-bold">69</td>
                <td className="px-3 py-2 text-center"><span className="bg-blue-500 text-white px-2 py-1 rounded text-xs font-bold">A+</span></td>
              </tr>
              <tr className="border-t bg-gray-50">
                <td className="px-3 py-2 font-medium">长江电力</td>
                <td className="px-3 py-2 text-center">20</td>
                <td className="px-3 py-2 text-center">10</td>
                <td className="px-3 py-2 text-center">16</td>
                <td className="px-3 py-2 text-center">15</td>
                <td className="px-3 py-2 text-center">7</td>
                <td className="px-3 py-2 text-center font-bold">68</td>
                <td className="px-3 py-2 text-center"><span className="bg-blue-500 text-white px-2 py-1 rounded text-xs font-bold">A+</span></td>
              </tr>
              <tr className="border-t">
                <td className="px-3 py-2 font-medium">中国广核</td>
                <td className="px-3 py-2 text-center">18</td>
                <td className="px-3 py-2 text-center">10</td>
                <td className="px-3 py-2 text-center">12</td>
                <td className="px-3 py-2 text-center">15</td>
                <td className="px-3 py-2 text-center">8</td>
                <td className="px-3 py-2 text-center font-bold">63</td>
                <td className="px-3 py-2 text-center"><span className="bg-blue-500 text-white px-2 py-1 rounded text-xs font-bold">A</span></td>
              </tr>
              <tr className="border-t bg-gray-50">
                <td className="px-3 py-2 font-medium">宁德时代</td>
                <td className="px-3 py-2 text-center">18</td>
                <td className="px-3 py-2 text-center">16</td>
                <td className="px-3 py-2 text-center">14</td>
              ...
              <tr className="border-t">
                <td className="px-3 py-2 font-medium">比亚迪</td>
                <td className="px-3 py-2 text-center">12</td>
                <td className="px-3 py-2 text-center">6</td>
                <td className="px-3 py-2 text-center">10</td>
                <td className="px-3 py-2 text-center text-red-600">8</td>
                <td className="px-3 py-2 text-center">3</td>
                <td className="px-3 py-2 text-center font-bold">39</td>
                <td className="px-3 py-2 text-center"><span className="bg-red-500 text-white px-2 py-1 rounded text-xs font-bold">B</span></td>
              </tr>
            </tbody>
          </table>
        </div>
